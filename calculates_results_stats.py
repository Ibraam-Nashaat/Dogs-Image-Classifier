...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic["pct_match"]=float(n_match/n_images)*100
    results_stats_dic["pct_correct_dogs"]=float(n_correct_dogs/n_dogs_img)*100
    results_stats_dic["pct_correct_breed"]=float(n_correct_breed/n_dogs_img)*100
    results_stats_dic["pct_correct_notdogs"]=float(n_correct_notdogs/n_notdogs_img)*100
